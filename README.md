...
- Modern UI/UX with Thai/beach-inspired color scheme
...
### Color Scheme
- **Primary**: Sea Green (#2E8B57) - representing the ocean
- **Secondary**: Golden Sand (#FFD700) - representing the beach
- **Accent**: Coral (#FF6B6B) - adding vibrancy
- **Supporting**: Deep Ocean Blue, Sky Blue, and neutral grays

### Typography
- **Font**: Poppins (Google Fonts) - modern and readable
- Hierarchy with different weights (300, 400, 500, 600, 700)
...
- **NUS College** - International perspective and digital expertise
- **Burapha University** - Local knowledge and cultural insights

## 📄 License

This project is created for educational purposes as part of a university collaboration between NUS College and Burapha University.
